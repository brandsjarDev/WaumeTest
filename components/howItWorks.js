...
const HowItWorks = ({ className }) => (
  <>
    <div
      className={`flex flex-col md:grid md:grid-cols-3 gap-10  md:justify-around pb-10 pt-10 md:pt-20 px-5 ${className}`}
    >
      ...
      {/* First Card */}
      <div className="grid grid-rows-3 justify-center content-center max-w-xs mx-5 ">
